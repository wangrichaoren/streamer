...
CvPointCloudNormalEstimationOMPModel::CvPointCloudNormalEstimationOMPModel()
    : _box(new QGroupBox())
...
unsigned int CvPointCloudNormalEstimationOMPModel::nPorts(PortType portType) const
{
...
bool CvPointCloudNormalEstimationOMPModel::eventFilter(QObject *object, QEvent *event)
{
    if (object == _box) {
...
NodeDataType CvPointCloudNormalEstimationOMPModel::dataType(PortType const portType,
...
std::shared_ptr<NodeData> CvPointCloudNormalEstimationOMPModel::outData(PortIndex portIndex)
{
    if (portIndex == 0) {
...
QJsonObject CvPointCloudNormalEstimationOMPModel::save() const
{
...
void CvPointCloudNormalEstimationOMPModel::load(const QJsonObject &js)
{
    r->setText(js["r"].toString());
}

void CvPointCloudNormalEstimationOMPModel::compute()
{
    ...
    nest.setInputCloud(d->getData());
    nest.setRadiusSearch(val);
    nest.compute (*_normal);
...
void CvPointCloudNormalEstimationOMPModel::setInData(std::shared_ptr<NodeData> nodeData,
