...
class CvMedianBlurModel : public NodeDelegateModel
{
    Q_OBJECT
...
public:
    ...
    QString name() const override { return QString("MedianBlurModel:中值滤波"); }

public:
    virtual QString modelName() const { return QString("MedianBlurModel"); }
